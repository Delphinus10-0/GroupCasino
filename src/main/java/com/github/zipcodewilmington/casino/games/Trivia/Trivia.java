...
public class Trivia implements GameInterface {
  private HashMap<Integer, Questions> trivia;
  public int currentScore;
  private Scanner input;
  // Assume PlayerInterface is implemented somewhere and provides necessary player functionalities.
...
//  public void play() {
//    // Play the game
//    // This can be your existing play logic
//  }
  ...
  public void triviaAdd() {
    ...
    trivia.put(1, new Questions("What is the capital of France?", List.of("A. Paris", "B. Rome", "C. Madrid", "D. Berlin"), "Paris"));
    trivia.put(2, new Questions("How many continents are there?", List.of("A. 8", "B. 7", "C. 6", "D. 5"), "7"));
    trivia.put(3, new Questions("Who wrote 'Romeo and Juliet'?", List.of("A. William Shakespeare", "B. Charles Dickens", "C. Jane Austen", "D. Mark Twain"), "William Shakespeare"));
    trivia.put(4, new Questions("What is the largest ocean on Earth?", List.of("A. Atlantic Ocean", "B. Indian Ocean", "C. Arctic Ocean", "D. Pacific Ocean"), "Pacific Ocean"));
    trivia.put(5, new Questions("Who painted the Mona Lisa?", List.of("A. Vincent van Gogh", "B. Leonardo da Vinci", "C. Pablo Picasso", "D. Claude Monet"), "Leonardo da Vinci"));
    trivia.put(6, new Questions("What is the hardest natural substance on Earth?", List.of("A. Gold", "B. Iron", "C. Diamond", "D. Quartz"), "Diamond"));
    trivia.put(7, new Questions("Which planet is known as the Red Planet?", List.of("A. Mars", "B. Jupiter", "C. Venus", "D. Saturn"), "Mars"));
    trivia.put(8, new Questions("What is the chemical symbol for gold?", List.of("A. Ag", "B. Au", "C. Fe", "D. Hg"), "Au"));
    trivia.put(9, new Questions("Who invented the telephone?", List.of("A. Thomas Edison", "B. Nikola Tesla", "C. Alexander Graham Bell", "D. Michael Faraday"), "Alexander Graham Bell"));
    trivia.put(10, new Questions("What is the smallest country in the world?", List.of("A. Monaco", "B. Nauru", "C. Liechtenstein", "D. Vatican City"), "Vatican City"));
    trivia.put(11, new Questions("What is the main ingredient in guacamole?", List.of("A. Tomato", "B. Avocado", "C. Onion", "D. Pepper"), "Avocado"));
    trivia.put(12, new Questions("In what year did the Titanic sink?", List.of("A. 1910", "B. 1912", "C. 1914", "D. 1916"), "1912"));
    trivia.put(13, new Questions("Who is the author of 'Harry Potter'?", List.of("A. J.R.R. Tolkien", "B. J.K. Rowling", "C. George R.R. Martin", "D. Stephen King"), "J.K. Rowling"));
    trivia.put(14, new Questions("What is the capital of Japan?", List.of("A. Seoul", "B. Beijing", "C. Tokyo", "D. Bangkok"), "Tokyo"));
    trivia.put(15, new Questions("How many elements are in the periodic table?", List.of("A. 112", "B. 114", "C. 116", "D. 118"), "118"));
    trivia.put(16, new Questions("What is the largest mammal in the world?", List.of("A. Elephant", "B. Blue whale", "C. Giraffe", "D. Rhinoceros"), "Blue whale"));
    trivia.put(17, new Questions("What is the fastest land animal?", List.of("A. Lion", "B. Cheetah", "C. Tiger", "D. Gazelle"), "Cheetah"));
    trivia.put(18, new Questions("Who developed the theory of relativity?", List.of("A. Isaac Newton", "B. Niels Bohr", "C. Albert Einstein", "D. Galileo Galilei"), "Albert Einstein"));
    trivia.put(19, new Questions("What is the currency of Japan?", List.of("A. Chinese yuan", "B. South Korean won", "C. Japanese yen", "D. Thai baht"), "Japanese yen"));
    trivia.put(20, new Questions("What organ is capable of regenerating tissue?", List.of("A. Heart", "B. Brain", "C. Liver", "D. Lung"), "Liver"));
    trivia.put(21, new Questions("Which gas is most abundant in the Earth's atmosphere?", List.of("A. Oxygen", "B. Hydrogen", "C. Carbon dioxide", "D. Nitrogen"), "Nitrogen"));
    trivia.put(22, new Questions("What year did the first man walk on the moon?", List.of("A. 1965", "B. 1966", "C. 1967", "D. 1969"), "1969"));
    trivia.put(23, new Questions("What is the longest river in the world?", List.of("A. Amazon River", "B. Nile River", "C. Yangtze River", "D. Mississippi River"), "Nile River"));
    trivia.put(24, new Questions("Who is known as the father of computers?", List.of("A. Charles Babbage", "B. Alan Turing", "C. John Atanasoff", "D. Konrad Zuse"), "Charles Babbage"));
    trivia.put(25, new Questions("What is the pH of water?", List.of("A. 5", "B. 6", "C. 7", "D. 8"), "7"));
    trivia.put(26, new Questions("Who was the first woman to win a Nobel Prize?", List.of("A. Marie Curie", "B. Dorothy Hodgkin", "C. Rosalind Franklin", "D. Ada Yonath"), "Marie Curie"));
    trivia.put(27, new Questions("What is the capital of Canada?", List.of("A. Toronto", "B. Vancouver", "C. Ottawa", "D. Montreal"), "Ottawa"));
    trivia.put(28, new Questions("What does DNA stand for?", List.of("A. Deoxyribonucleic Acid", "B. Dinitrogen Amonoxide", "C. Dicarboxylic Nucleic Amide", "D. Deoxycytidine Acid"), "Deoxyribonucleic Acid"));
    trivia.put(29, new Questions("Who wrote 'The Odyssey'?", List.of("A. Homer", "B. Virgil", "C. Plato", "D. Aristotle"), "Homer"));
    trivia.put(30, new Questions("What is the boiling point of water at sea level in Celsius?", List.of("A. 90", "B. 95", "C. 100", "D. 105"), "100"));
    trivia.put(31, new Questions("Who discovered penicillin?", List.of("A. Marie Curie", "B. Alexander Fleming", "C. Louis Pasteur", "D. Gregory Mendel"), "Alexander Fleming"));
    trivia.put(32, new Questions("What is the largest desert in the world?", List.of("A. Gobi", "B. Sahara", "C. Arabian", "D. Kalahari"), "Sahara Desert"));
    trivia.put(33, new Questions("Who was the first president of the United States?", List.of("A. Thomas Jefferson", "B. Abraham Lincoln", "C. George Washington", "D. John Adams"), "George Washington"));
    trivia.put(34, new Questions("What is the currency of the European Union?", List.of("A. Pound Sterling", "B. Euro", "C. Swiss Franc", "D. U.S. Dollar"), "Euro"));
    trivia.put(35, new Questions("How many teeth does an adult human have?", List.of("A. 28", "B. 30", "C. 32", "D. 34"), "32"));
    trivia.put(36, new Questions("What is the capital of Australia?", List.of("A. Sydney", "B. Melbourne", "C. Canberra", "D. Brisbane"), "Canberra"));
    trivia.put(37, new Questions("What is the largest planet in our solar system?", List.of("A. Saturn", "B. Jupiter", "C. Uranus", "D. Neptune"), "Jupiter"));
    trivia.put(38, new Questions("What year did World War II end?", List.of("A. 1943", "B. 1944", "C. 1945", "D. 1946"), "1945"));
    trivia.put(39, new Questions("What is the capital of Italy?", List.of("A. Florence", "B. Milan", "C. Venice", "D. Rome"), "Rome"));
    trivia.put(40, new Questions("What is the largest island in the world?", List.of("A. New Guinea", "B. Borneo", "C. Madagascar", "D. Greenland"), "Greenland"));
  }
  @Override
  public void play (){
